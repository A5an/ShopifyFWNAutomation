...
export default function InvoiceReview() {
  const { extractedData, suppliers } = useLoaderData<typeof loader>();
  ...
  useEffect(() => {
    ...
    setEditableSupplier(extractedData.supplier);
              ...
              <BlockStack gap="300">
                ...
                <form method="post">
                  <InlineStack gap="300">
                    ...
                    <Button url="/app/upload" disabled={isSubmitting}>
                      Back to Upload
                    </Button>
                  </InlineStack>
                </form>
          ...
          <Card>
            <BlockStack gap="300">
              ...
              >
                <iframe
                  src={
                    extractedData.pdfFilePath ||
                    "/pdfs/inv_1754051006458_5w2rz9yi2_1754051006461_psychology-cheat-sheet.pdf"
                  }
                  style={{
                    width: "100%",
                    height: "100%",
